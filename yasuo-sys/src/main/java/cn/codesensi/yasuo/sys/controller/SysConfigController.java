...
public class SysConfigController extends BaseController {
     ...
     * @param sysConfig 实体类
     */
    // @LogOperate(operateType = OperateType.INSERT, description = "新增一条系统配置表数据")
     ...
     * @param id 主键id
     */
    // @LogOperate(operateType = OperateType.DELETE, description = "根据id删除一条系统配置表数据")
     ...
     * @param sysConfig 实体类
     */
    @LogOperate(operateType = OperateType.UPDATE, description = "根据id更新一条系统配置表数据")
     ...
     */
    // @LogOperate(operateType = OperateType.QUERY, description = "条件查询系统配置表分页列表", isSaveResponseData = false)
     ...
     */
    // @LogOperate(operateType = OperateType.QUERY, description = "根据id查询系统配置表详情")
