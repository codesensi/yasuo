...
public class SysUserRoleController extends BaseController {
     ...
     */
    // @LogOperate(operateType = OperateType.INSERT, description = "新增一条用户角色关联表数据")
     ...
     * @param id 主键id
     */
    // @LogOperate(operateType = OperateType.DELETE, description = "根据id删除一条用户角色关联表数据")
     ...
     * @param sysUserRole 实体类
     */
    // @LogOperate(operateType = OperateType.UPDATE, description = "根据id更新一条用户角色关联表数据")
     ...
     */
    // @LogOperate(operateType = OperateType.QUERY, description = "条件查询用户角色关联表分页列表", isSaveResponseData = false)
     ...
     */
    // @LogOperate(operateType = OperateType.QUERY, description = "根据id查询用户角色关联表详情")
